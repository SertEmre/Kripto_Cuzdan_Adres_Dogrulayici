...
//ETH adres kontrolü adres uzunuğu 42 ilk iki karakteri sırasıyla 0 ve x olmalı
...
//BTC adres kontolü genellikle 26-35 karakterli ve '1' veya '3' ile başlar
...
printf("Girmiş oldugunuz adres gecersiz!");
}
    return 0;
}
